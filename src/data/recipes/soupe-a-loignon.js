...
const recipe = {
  ...
  ingredients: [
    { amount: "6",      item: "large yellow onions, thinly sliced" },
    { amount: "4 tbsp", item: "unsalted butter",                 match: "unsalted butter" },
    { amount: "1 tbsp", item: "olive oil",                       match: "olive oil" },
    { amount: "½ cup",  item: "dry white wine or sherry" },
    { amount: "8 cups", item: "beef stock (good quality)" },
    { amount: "2",      item: "thyme sprigs" },
    { amount: "1",      item: "bay leaf" },
    { amount: "1 tsp",  item: "sugar" },
    { amount: "4",      item: "thick baguette slices, toasted" },
    { amount: "2 cups", item: "Gruyère, grated" },
